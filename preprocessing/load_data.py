...
def combine_mask():
    ...
    """
    folder_base = os.path.join(dir, 'CelebAMask-HQ-mask-anno/')
    folder_save = os.path.join(dir, 'CelebAMaskHQ-mask/')
...
def split_data(train_count, valid_count, test_count):
    ...
    splitting = pd.read_csv(split_path, na_filter=False)
    ...
    for t in range(img_num):
        ...
        group_id = splitting.iloc[celebA]['partition']
        print(group_id)
...
if __name__ == "__main__":
    label_list = ['skin', 'nose', 'eye_g', 'l_eye',
                  ...
                  'neck_l', 'neck', 'cloth']
    ROOT_DIR = 'c:/Users/panse/Workspace2022/face_proj/Face_segmentation/CelebAMask-HQ'
    DATA_DIR = '../data/'
    dir = 'c:/Users/panse/Workspace2022/face_proj/Face_segmentation/CelebAMask-HQ'
    img_num = 30000
    main()
